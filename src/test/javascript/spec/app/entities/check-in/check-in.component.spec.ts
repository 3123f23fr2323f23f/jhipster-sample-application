...
import { CheckInComponent } from 'app/entities/check-in/check-in.component';
...
describe('Component Tests', () => {
    describe('CheckIn Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.checkIns[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
